...
public class Proto2CSEditor : MonoBehaviour
{
    ...
    public static void AllProto2CS()
    {
        ...
        string hotfixMessageCodePath = Path.Combine(rootDir, "Assets", "HotUpdateProgress/Servers", "ProtoMessage/");
 
        string argument2 = $"--csharp_out=\"{hotfixMessageCodePath}\" --proto_path=\"{protoDir}\" SocketGameProtocol.proto";
        print(protoc+"------------------+++"+argument2);
